...
.NOTES
    Website: https://stackoverflow.com/questions/13257775/powershells-clear-history-doesnt-clear-history

.EXAMPLE
    ❯ Clear-SavedHistory
    Clears your PowerShell history
#>
...
function Clear-SavedHistory {
    ...
    $havePSReadline = ($null -ne (Get-Module -ErrorAction SilentlyContinue PSReadline))
    ...
    if ($havePSReadline) {
        ...
        if (Test-Path (Get-PSReadlineOption).HistorySavePath) {
            ...
            Remove-Item -ErrorAction Stop (Get-PSReadlineOption).HistorySavePath
