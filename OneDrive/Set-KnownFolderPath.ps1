...
# #$folderList = @("Desktop", "Documents", "Downloads", "Music", "Pictures", "Videos")
# $folderList = @("Desktop", "Documents", "Pictures", "Videos")
# foreach ($folder in $folderList) {
#     Set-KnownFolderPath -KnownFolder $folder -Path "$env:USERPROFILE\$($folder)"
# }
